...
$tbl['dashboard_links']="
CREATE TABLE IF NOT EXISTS  ".$table_prefix."dashboard_links (
  `link_id` int(14) NOT NULL,
...
ALTER TABLE  ".$table_prefix."dashboard_links
  ADD PRIMARY KEY (`link_id`),
  ADD KEY `dish_name` (`link`);
  
  ALTER TABLE  ".$table_prefix."dashboard_links
  MODIFY `link_id` int(14) NOT NULL AUTO_INCREMENT;
";
...
ALTER TABLE  ".$table_prefix."location_countries
  ...
  ALTER TABLE  ".$table_prefix."location_countries MODIFY `country_id` int(11) NOT NULL AUTO_INCREMENT;";
...
ALTER TABLE  ".$table_prefix."paypal_payment MODIFY `id` int(14) NOT NULL AUTO_INCREMENT;";
...
ALTER TABLE  ".$table_prefix."rating MODIFY `id` int(14) NOT NULL AUTO_INCREMENT;";
...
ALTER TABLE  ".$table_prefix."rating_meaning MODIFY `id` int(14) NOT NULL AUTO_INCREMENT;";
...
ALTER TABLE  ".$table_prefix."receive_post MODIFY `id` int(14) NOT NULL AUTO_INCREMENT;";
...
ALTER TABLE  ".$table_prefix."review MODIFY `id` int(14) NOT NULL AUTO_INCREMENT;";
...
ALTER TABLE  ".$table_prefix."shipping_rate MODIFY `id` int(14) NOT NULL AUTO_INCREMENT;";
...
ALTER TABLE  ".$table_prefix."size MODIFY `size_id` int(14) NOT NULL AUTO_INCREMENT;";
...
ALTER TABLE  ".$table_prefix."sms_broadcast MODIFY `broadcast_id` int(14) NOT NULL AUTO_INCREMENT;";
...
ALTER TABLE  ".$table_prefix."sms_broadcast_details MODIFY `id` int(14) NOT NULL AUTO_INCREMENT;";
...
ALTER TABLE  ".$table_prefix."sms_package MODIFY `sms_package_id` int(14) NOT NULL AUTO_INCREMENT;";
...
ALTER TABLE  ".$table_prefix."sms_package_trans MODIFY `id` int(14) NOT NULL AUTO_INCREMENT;";
...
ALTER TABLE  ".$table_prefix."stripe_logs MODIFY `id` int(14) NOT NULL AUTO_INCREMENT;";
...
ALTER TABLE  ".$table_prefix."subcategory MODIFY `subcat_id` int(14) NOT NULL AUTO_INCREMENT;";
...
ALTER TABLE  ".$table_prefix."subcategory_item MODIFY `sub_item_id` int(14) NOT NULL AUTO_INCREMENT;";
...
ALTER TABLE  ".$table_prefix."voucher MODIFY `voucher_id` int(14) NOT NULL AUTO_INCREMENT;";
...
ALTER TABLE  ".$table_prefix."voucher_list MODIFY `voucher_id` int(14) NOT NULL AUTO_INCREMENT;";
...
ALTER TABLE  ".$table_prefix."voucher_new MODIFY `voucher_id` int(14) NOT NULL AUTO_INCREMENT;";
...
ALTER TABLE  ".$table_prefix."withdrawal
  ...
  ALTER TABLE  ".$table_prefix."withdrawal MODIFY `withdrawal_id` int(14) NOT NULL AUTO_INCREMENT;";
...
ALTER TABLE  ".$table_prefix."zipcode MODIFY `zipcode_id` int(14) NOT NULL AUTO_INCREMENT;";
