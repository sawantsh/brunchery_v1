...
$dbname=getenv("BRUNCHERRY_DB_NAME");
$dbhost=getenv("BRUNCHERRY_HOSTNAME");
$dbport=getenv("BRUNCHERRY_PORT");
$dbuser=getenv("BRUNCHERRY_USERNAME");
$dbpwd=getenv("BRUNCHERRY_PASSWORD");

return array(
	'name'=>'Bruncherry Store',
