...
if (!class_exists('AjaxAdmin'))
{
	class AjaxAdmin extends DbExt
	{
		...
		{			
			...
			/*DELETE IMAGE IF TABLE IS dashboard_links*/
			if($this->data['tbl']=="dashboard_links"){
				if($old_data=Yii::app()->functions->GetDashboardLink($this->data['row_id'])){
				   $filename_to_delete[]=$old_data['photo'];
				}
			}
...
//dump($params); die();
		...
		public function partnerSignupSubmit() {
