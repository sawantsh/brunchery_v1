...
Regards
 - [sitename]'
		...
		//Bruncherry updates...
		$option[]=array(
			'option_name'=>'customer_ask_address',
			'option_value'=>'2'
		);
		$option[]=array(
			'option_name'=>'theme_hide_logo',
			'option_value'=>'2'
		);
		$option[]=array(
			'option_name'=>'theme_hide_how_works',
			'option_value'=>'2'
		);
		$option[]=array(
			'option_name'=>'theme_hide_cuisine',
			'option_value'=>'2'
		);
		$option[]=array(
			'option_name'=>'disabled_subscription',
			'option_value'=>'yes'
		);
		$option[]=array(
			'option_name'=>'social_flag',
			'option_value'=>'1'
		);
		$option[]=array(
			'option_name'=>'show_language',
			'option_value'=>'1'
		);
		$option[]=array(
			'option_name'=>'theme_search_merchant_name',
			'option_value'=>'2'
		);
		$option[]=array(
			'option_name'=>'theme_search_cuisine',
			'option_value'=>'2'
		);
		$option[]=array(
			'option_name'=>'theme_search_foodname',
			'option_value'=>'2'
		);
		$option[]=array(
			'option_name'=>'theme_hide_footer_section1',
			'option_value'=>'2'
		);
		$option[]=array(
			'option_name'=>'theme_hide_footer_section2',
			'option_value'=>'2'
		);
		$option[]=array(
			'option_name'=>'merchant_tbl_book_disabled',
			'option_value'=>'2'
		);
		$option[]=array(
			'option_name'=>'theme_map_tab',
			'option_value'=>'2'
		);
		$option[]=array(
			'option_name'=>'theme_photos_tab',
			'option_value'=>'2'
		);
		$option[]=array(
			'option_name'=>'theme_time_pick',
			'option_value'=>'2'
		);
		$option[]=array(
			'option_name'=>'admin_menu_allowed_merchant',
			'option_value'=>'2'
		);
		$option[]=array(
			'option_name'=>'admin_activated_menu',
			'option_value'=>''
		);
