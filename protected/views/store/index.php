...
<div class="sections section-how-it-works f-hide">
<div class="container">
 <h2><?php echo t("How it works")?></h2>
 <p class="center"><?php echo t("hello")?></p>
...
<?php 
	$this->renderPartial('/front/dashboard-links',array());
?>
...
?>
  ...
  <div class="row home-resto-content">
  <?php if ($res=Yii::app()->functions->searchRestaurants()):?>
          ...
          <?php if ( $openHrs=$val['open_hrs']):?>
            <?php foreach ($openHrs as $o):?>
              <?php if (strtolower(date('l')) == $o['day']):?>
                <?php $isOpen = true;?>
                <p class="open">Open <?php echo $o['hours']?></p>
              <?php endif;?> 
            <?php endforeach;?>
          <?php endif;?>
          <?php if (!$isOpen):?>
  ...
  <div class="more-coming more-line">
    <span class="more-text">More coming soon!</span>
  </div>
  <?php else:?>
  <div class="more-coming more-line">
    <span class="more-text">Sorry, No restaurants found matching search criteria!</span>
  </div>
  <?php endif;?>
</div> <!--container-->
</div>
...
<div class="sections section-cuisine f-hide">
