...
<div class="sections section-payment-option">
   <div class="container bruncherry-confirm">
   <div class="store-topbar">
      <div class="resto-info">
        <div class="trim-text text-center"><a class="pull-left" href="<?php echo Yii::app()->createUrl('/menu-'. trim($merchant_info['restaurant_slug']) )?>"><i class="ion-ios-arrow-back"></i></a> Confirm Order</div>
      </div>
		</div>
    ...
    <div class="dining-options section-border clearfix">
      <div class="relative">
      <h4 class="rgt-border">Dine In or Dash Out?</h4>
      <div class="radio-group">
      <?php echo CHtml::radioButton('dining-opt',false,
         array('class'=>"icheck",'value'=>'dinein'))?> 
    ...
    <!--dining-options -->
     ...
     <div class="confirm-order-details section-border"><!-- RIGHT CONTENT STARTS HERE-->
  ...
  <input type="hidden" value="<?php echo $openHours?>" id="openTimings"/>
   <div class="arrival-time section-border">
      <div class="relative">
        ...
        <div class="date-time-picker">
          <input type="text" class="timepick" name="arrival-time" id="arrival-time" placeholder="Arrival time">
        </div>
      </div>
    </div>
    <!--arrival-time -->
   ...
   <div class="store-cart-banner">
    <div class="container relative proceed-to-pay">
    <div class="confirm-cart_total">

    </div>  
            <a href="javascript:;" class="place_order orange-button medium"><?php echo t("Proceed to Payment")?></a>
      </div>
    </div>

     <div class="pay-options section-border">
    ...
    //  echo CHtml::hiddenField('delivery_type',$s['kr_delivery_options']['delivery_type']);
     ...
     <?php else :?> <!-- DELIVERY-->                          	       	      
		  ...
		  <p class="f-hide">
	       ...
	       <div class="top10">
            ...
            <div class="address-block f-hide">
              <div class="row top10">
                <div class="col-md-10">
             ...
             <div class="row top10  f-hide">
                <div class="col-md-12">
                  <?php echo CHtml::textField('delivery_instruction','',array(
	               'class'=>'full-width',
	               'placeholder'=>Yii::t("default","Add alergy notes")   
	              ))?>
	             </div> 
              </div> 
     ...
     <h4 class="rgt-border">Choose payment option</h4>
     <?php 
