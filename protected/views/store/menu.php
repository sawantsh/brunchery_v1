...
<div class="sections section-menu store-food-listing relative">
<div class="container food-category bruncherry-container">
<div class="store-topbar">
					<div class="resto-info">
						<?php echo "<div class='text-center rest-name'><a class='pull-left' href='/'><i class='ion-ios-arrow-back'></i></a>".$data['restaurant_name']."</div>" ?>
					</div></div>
  ...
  <div class="row">
     ...
     <div class="border menu-left-content">
         
        <div class="tabs-wrapper" id="menu-tab-wrapper">
	    <ul id="tabs" class="f-hide" >
		    <li class="active">
     ...
     <div id="menu-right-content" class="f-hide border menu-right-content <?php echo $disabled_addcart=="yes"?"hide":''?>" >
     ...
     <div class="theiaStickySidebar">
      <div class="box-grey rounded  relative">
        ...
        <!--CART-->
        <div class="inner line-top relative f-hide">
        ...
        <div class="inner line-top relative delivery-option center">
		   ...
		   <div class="store-delivery-options f-hide">
           ...
           <div class="delivery_asap_wrap">            
            ...
            <?php if ( $detect->isMobile() ) :?>
             <?php                           
             echo CHtml::dropDownList('delivery_time',"23:30",
...
<div class="store-cart-banner">
	<div class="container relative">
				...
				<div class="placeholder-cart-icon icon center-cropped" style="display:none"><i class="ion-ios-cart"></i><span style="color:white" class="item-count">0</span></div>
				<?php //if ( 1==1):?>
