   ...
   <div class="inner">
      ...
      <!-- <div class="text-center bottom10">
	   ...
	   <tbody>	
	       ...
	       FunctionsV3::receiptTableRow('Restaurant Name',clearString($data['merchant_name']));
	       ...
	       FunctionsV3::receiptTableRow('Dine in/Dash out', t($data['trans_type'] == "dinein" ? "Dine In" : "Dash out") );
	       ...
	       FunctionsV3::receiptTableRow('Order Date',  Yii::app()->functions->translateDate($trn_date) );
