...
var ajax_url=host_name+'/bruncherry/External';
...
jQuery(document).ready(function() {		
	...
	getScripts([host_name+"/bruncherry/assets/vendor/fancybox/source/jquery.fancybox.js", host_name+"/bruncherry/assets/vendor/jquery.ui.timepicker-0.0.8.js"], function () { finishLoadingScript(); });
		            
	$('<link>')
    .appendTo('head')
    .attr({type : 'text/css', rel : 'stylesheet'})
    .attr('href', host_name+'/bruncherry/assets/css/external.css?ver=1');
    
    $('<link>')
    .appendTo('head')
    .attr({type : 'text/css', rel : 'stylesheet'})
    .attr('href', host_name+'/bruncherry/assets/vendor/uikit/css/uikit.almost-flat.min.css');
    
    $('<link>')
    .appendTo('head')
    .attr({type : 'text/css', rel : 'stylesheet'})
    .attr('href', host_name+'/bruncherry/assets/vendor/fancybox/source/jquery.fancybox.css');
